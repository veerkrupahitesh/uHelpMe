...
public class AdpOtherHelpMe extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdpOtherHelpMe(Context mContext, ArrayList<PostedJobModel> jobPostSeekerList, boolean showLoader) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            View itemView = LayoutInflater.from(context).inflate(R.layout.list_item_other_helpme, parent, false);
...
//            myViewHolder.imgHelpInfo.setTag(postedJobModel);
            ...
            myViewHolder.tvTimeDate.setText(postedJobModel.getJobPostTimeDiff());
            // myViewHolder.txvDescription.setText("Applicants are ");

            Utils.setImage(postedJobModel.getJobPhoto(), R.drawable.img_user_placeholder, myViewHolder.imgHelpPhoto);
            Utils.setImage(postedJobModel.getCategoryIcon1(), R.drawable.img_pin_blue, myViewHolder.imgCategoryIcon);
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        View view;
        TextView txvName, txvDescription, tvTimeDate;
        ImageView imgHelpPhoto/*, imgHelpInfo, imgHelpEdit, imgHelpChat*/, imgCategoryIcon;
        ...
        MyViewHolder(View itemView) {
            ...
            imgCategoryIcon = (ImageView) itemView.findViewById(R.id.img_categoryIcon);
...
//            imgHelpChat = (ImageView) itemView.findViewById(R.id.img_ChatIcon);
            ...
            txvDescription = (TextView) itemView.findViewById(R.id.tv_helpDetail);
            txvDescription.setTypeface(MyApplication.getInstance().FONT_WORKSANS_MEDIUM);

            tvTimeDate = (TextView) itemView.findViewById(R.id.tv_dateTime);
            tvTimeDate.setTypeface(MyApplication.getInstance().FONT_WORKSANS_MEDIUM);
