...
public class AdpOtherOffer extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdpOtherOffer(Context mContext, ArrayList<PostedJobModel> list, boolean showLoader) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            View itemView = LayoutInflater.from(context).inflate(R.layout.list_item_other_offer, parent, false);
...
//            myViewHolder.imgHelpInfo.setTag(myOfferModel);
            ...
            myViewHolder.tvTimeDate.setText(myOfferModel.getJobPostTimeDiff());

            Utils.setImage(myOfferModel.getJobPhoto(), R.drawable.img_user_placeholder, myViewHolder.imgHelpPhoto);
            Utils.setImage(myOfferModel.getCategoryIcon1(), R.drawable.img_pin_blue, myViewHolder.imgCategoryIcon);
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvHelpName, /*tvTimeLabel, tvTimeRemaining,*/ tvOfferLabel,tvTimeDate;
        Button btnAmount;
