...
public class AdpSpecificCategoryChatList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdpSpecificCategoryChatList(Context context, ArrayList<AllHelpOfferModel> list, boolean showLoader) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_FOOTER) {
            ...
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_category_chat_list, parent, false);
